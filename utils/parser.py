...
class HearWiseArgs:
    ...
    def parse_arguments():
        ...
        parser.add_argument('--use_wcr', help='Use WCR for signal processing', type=bool, required=True)
        parser.add_argument('--use_efficientnet', help='Use EfficientNet for signal processing', type=bool, required=True)
